...
template<>
gl::Texture& gl::Texture::Load<image::TGA>(image::TGA const& source) {
    if (source.bits_per_pixel != 24)
        throw std::invalid_argument("Error: TGA not 24-bit uncompressed.");
    Activate();
...
image::TGA::TGA(string const& filename) {
